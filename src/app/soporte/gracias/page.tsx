...
/**
 * Landing after Netlify Forms accepts the /soporte submission.
 * Reachable via the form's `action="/soporte/gracias"` after a successful POST.
 */
export const metadata: Metadata = {
  title: SOPORTE.thanks.meta.title,
  description: SOPORTE.thanks.meta.description,
  robots: { index: false, follow: true },
};

export default function SoporteGraciasPage() {
  const t = SOPORTE.thanks;
