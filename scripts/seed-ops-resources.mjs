...
const RESOURCES = [
  {
    ...
    body: [
      ...
      "  https://app.ingleshotelero.com/hr/login",
  ...
  },
  {
    ...
    kind: "link",
    url: "https://app.ingleshotelero.com",
    body: [
      "PWA producto (empleados):   https://app.ingleshotelero.com",
      "Landing marketing:          https://ingleshotelero.com",
      "Master OS (equipo):         https://ingleshotelero.com/admin",
      "  · Atajos (todo en 1):     https://app.ingleshotelero.com/masteros/launch",
      "HR dashboard (hoteles):     https://app.ingleshotelero.com/hr/login",
      "Examen de colocación (público / warm leads):",
      "                            https://app.ingleshotelero.com/colocacion",
      "  · Editar / ver leads:     https://app.ingleshotelero.com/masteros/colocacion",
      "Onboarding (hotel + empleado): https://app.ingleshotelero.com/onboarding",
      "Slidedeck / Pitch:          https://app.ingleshotelero.com/pitch",
      "Progreso del aprendiz:      https://app.ingleshotelero.com/practice/progress",
    ].join("\n"),
  },
  {
