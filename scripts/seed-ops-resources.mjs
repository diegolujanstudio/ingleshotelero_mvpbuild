...
const RESOURCES = [
  ...
  },
  {
    ...
    body: [
      ...
      "  · Atajos (todo en 1):     https://ingleshotelero.netlify.app/masteros/launch",
      "HR dashboard (hoteles):     https://ingleshotelero.netlify.app/hr/login",
      "Examen de colocación (público / warm leads):",
      "                            https://ingleshotelero.netlify.app/colocacion",
      "  · Editar / ver leads:     https://ingleshotelero.netlify.app/masteros/colocacion",
      "Onboarding (hotel + empleado): https://ingleshotelero.netlify.app/onboarding",
      "Slidedeck / Pitch:          https://ingleshotelero.netlify.app/pitch",
